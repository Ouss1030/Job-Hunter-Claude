...
# Les artefacts réels sont nommés <module>_<AAAAMMJJ>_<HHMMSS>.<ext>.
# Le joker est ancré sur un chiffre pour ne pas capturer les sorties
# d'audit, qui insèrent _audit_ ou _current_batch_audit_ avant
# l'horodatage : "delta_tracker_v1_*.json" attrapait
# delta_tracker_v1_current_batch_audit_*.json, plus récent, et le
# sélectionnait comme dernier Delta.
ARTIFACT_PATTERNS = {
