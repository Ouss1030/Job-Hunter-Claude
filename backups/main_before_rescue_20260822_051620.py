...
# Mesuré le 19/08/2026 : 3 termes sur 199 dépassaient le plafond de 100
# ("opérateur de production" 360, "quality control" 170, "contrôle qualité" 165).
# Relever le plafond récupère 295 offres absentes de la base, dont 4 dépassent
# 50 de score — dont un "Quality controler/laborant" à 66.3. Gain modeste mais
# réel, et sans coût : les termes non tronqués ne génèrent pas d'appel de plus.
FOREM_MAX_PER_KEYWORD = 500
