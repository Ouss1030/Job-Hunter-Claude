"""
JOB HUNTER BELGIUM
JOB REFRESH - VERSION 1.1

Objectif
========
Prendre le dernier application_preparation_v1_*.json, relire LIVE les offres
FOREM / ACTIRIS / SMARTRECRUITERS avec les connecteurs déjà validés du projet,
...
def fetch_live_detail(item):
    ...
    return {
        ...
        "matching_text_length": 0,
        "structured": {},
        "error": f"Source non prise en charge par Job Refresh V1.1 : {source}",
    }
...
def snapshot_text(item, detail, assessment):
    ...
    lines = [
        "JOB REFRESH V1.1 - SNAPSHOT OFFRE",
        "=" * 78,
...
def refresh_batch(items):
    ...
    print("\n" + "=" * 78)
    print("JOB REFRESH V1.1 - LECTURE LIVE")
    print("=" * 78)
