...
def start_main_logging():
    ...
    path = LOG_DIR / f"job_hunter_main_v10_4_{timestamp}.txt"
...
def collect_all_jobs():
    ...
    smartrecruiters = collect_smartrecruiters_jobs()

    standard_jobs = forem + actiris + talent + smartrecruiters
...
def persist_initial_raw_collection(all_jobs):
    ...
    result = save_raw_jobs(
        all_jobs,
        notes=(
            "MAIN V10.4 - RAW immédiatement après collecte "
...
def main():
    ...
    print("SMARTRECRUITERS :", len(collection["smartrecruiters"]))
