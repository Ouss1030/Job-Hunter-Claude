...
TRASIS_VERSION = "1.0"
URL = "https://www.trasis.com/fr/careers/"


def collect_trasis_jobs():
    s = session()
    ...
    for anchor in soup.find_all("a", href=True):
        ...
        if "/fr/career/" not in href:
            continue

        url = urljoin(r.url, href).split("#", 1)[0]
        links[url] = clean(anchor.get_text(" ", strip=True))
